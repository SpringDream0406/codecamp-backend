...
import { PointService } from "./mvc/controllers/services/point.service copy.js";
...
const pointService = new PointService()     // 3. 의존성 주입으로 쿠폰 구매 방식을 포인트결제로 안전하게 변경 가능
                                            ...
                                            //    => 이 역할을 대신 해주는 Nestjs 기능: IoC 컨테이너 (알아서 new 해서 넣어주는 얘. 즉, DI 해줌)
                                            //                                    => IOC: Inversion-Of-Control

                                            // 3. "의존성주입"으로 싱글턴패턴 구현 가능해짐
                                            //    => "의존성주입"이면, "싱글톤패턴"인가? 그건 아님!!

// 상품API
const productController = new ProductController(cashService, productService)
app.post("/products/buy", productController.buyProduct); // 상품 구매하기 API
app.post("/products/refund", productController.refundPorudct) // 상품 환불하기 API
